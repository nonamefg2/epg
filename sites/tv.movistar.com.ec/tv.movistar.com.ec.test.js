...
it('can generate valid url', () => {
  expect(url({ channel, date })).toBe(
    'https://contentapi-ec.cdn.telefonica.com/41/default/es-EC/schedules?fields=Pid,Title,Description,ChannelName,LiveChannelPid,Start,End,images.videoFrame,AgeRatingPid&orderBy=START_TIME%3Aa&filteravailability=false&starttime=1669680000&endtime=1669766400&livechannelpids=lch2219'
  )
})
