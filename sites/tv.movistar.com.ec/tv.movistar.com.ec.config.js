...
module.exports = {
  ...
  channels: 'tv.movistar.com.ec_ec.channels.xml',
  url({ channel, date }) {
  ...
  async channels() {
    const items = await axios
      .get(
        `https://contentapi-ec.cdn.telefonica.com/41/default/es-EC/contents/all?contentTypes=LCH&fields=Pid,Name&orderBy=contentOrder&limit=1000`
      )
